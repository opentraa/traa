...
#if defined(TRAA_ARCH_X86_FAMILY) && defined(_MSC_VER)
#include <intrin.h>
#endif
...
#if defined(TRAA_ARCH_X86_FAMILY)

#if defined(TRAA_ENABLE_AVX2)
...
int get_cpu_info(CPU_FEATURE_X86 feature) {
  int cpu_info[4];
  __cpuid(cpu_info, 1);
  if (feature == CPU_FEATURE_X86_SSE2) {
    return 0 != (cpu_info[3] & 0x04000000);
  }
  if (feature == CPU_FEATURE_X86_SSE3) {
    return 0 != (cpu_info[2] & 0x00000001);
  }
#if defined(TRAA_ENABLE_AVX2)
  if (feature == CPU_FEATURE_X86_AVX2) {
    int cpu_info7[4];
    __cpuid(cpu_info7, 0);
...
#endif // TRAA_ENABLE_AVX2
  if (feature == CPU_FEATURE_X86_FMA3) {
