...
#ifndef TRAA_BASE_DEVICES_SCREEN_MOCK_DESKTOP_CAPTURER_CALLBACK_H_
#define TRAA_BASE_DEVICES_SCREEN_MOCK_DESKTOP_CAPTURER_CALLBACK_H_
...
#endif // TRAA_BASE_DEVICES_SCREEN_MOCK_DESKTOP_CAPTURER_CALLBACK_H_
