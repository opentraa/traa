...
#ifndef TRAA_BASE_DEVICES_SCREEN_DESKTOP_FRAME_GENERATOR_H_
#define TRAA_BASE_DEVICES_SCREEN_DESKTOP_FRAME_GENERATOR_H_
...
#endif // TRAA_BASE_DEVICES_SCREEN_DESKTOP_FRAME_GENERATOR_H_
