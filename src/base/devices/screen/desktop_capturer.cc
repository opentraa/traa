...
#if defined(TRAA_OS_WINDOWS)
  if (options.allow_wgc_window_capturer() && wgc_capturer_win::is_wgc_supported(capture_type::window)) {
...
#if defined(TRAA_OS_WINDOWS)
  if (options.allow_wgc_screen_capturer() && wgc_capturer_win::is_wgc_supported(capture_type::screen)) {
