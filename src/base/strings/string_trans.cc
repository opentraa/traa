...
std::wstring string_trans::ascii_to_unicode(const std::string &str) {
  if (str.empty()) {
    return std::wstring();
  }
...
std::string string_trans::unicode_to_ascii(const std::wstring &wstr) {
  if (wstr.empty()) {
    return std::string();
  }
...
std::string string_trans::ascii_to_utf8(const std::string &str) {
  if (str.empty()) {
    return std::string();
  }
...
std::string string_trans::utf8_to_ascii(const std::string &utf8) {
  if (utf8.empty()) {
    return std::string();
  }
...
std::string string_trans::unicode_to_utf8(const std::wstring &wstr) {
  if (wstr.empty()) {
    return std::string();
  }
...
std::wstring string_trans::utf8_to_unicode(const std::string &utf8) {
  if (utf8.empty()) {
    return std::wstring();
  }
